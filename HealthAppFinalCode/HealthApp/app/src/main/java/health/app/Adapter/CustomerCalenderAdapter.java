...
public class CustomerCalenderAdapter extends RecyclerSwipeAdapter<CustomerCalenderAdapter.SimpleViewHolder> {

    private Context mContext;

    List<SessionListResponse.SessionData.Sessions> calenderLists =new ArrayList<>();

    public CustomerCalenderAdapter(Context context, List<SessionListResponse.SessionData.Sessions> calenderLists ) {
    ...
    @Override
    public CustomerCalenderAdapter.SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.calender_list, parent, false);
        return new CustomerCalenderAdapter.SimpleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CustomerCalenderAdapter.SimpleViewHolder viewHolder, final int position) {
        final SessionListResponse.SessionData.Sessions item = calenderLists.get(position);
...
//        viewHolder.tvLocation.setText(item.getAddress());
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void deleteSlot(final SessionListResponse.SessionData.Sessions item) {
